"""
ipython -i --pdb scripts/train_model.py -- --model cropped_jan05_2 --data 128_20151029 --use_cropped --as_grey --overwrite --no_test
"""
...
model_fname = './models/cropped_jan05_2.pkl'
model_accuracy_fname = './models/cropped_jan05_2_accuracy.pkl'
model_history_fname = './models/cropped_jan05_2_history.pkl'
model_graph_fname = './models/cropped_jan05_2_history.png'
...
l = conv2dbn(l, name='l4c1', num_filters=96, filter_size=(3, 3), stride=2, **conv_kwargs)
l = conv2dbn(l, name='l4c2', num_filters=96, filter_size=(3, 3), **conv_kwargs)
l = conv2dbn(l, name='l4c3', num_filters=96, filter_size=(3, 3), **conv_kwargs)
l = conv2dbn(l, name='l4c4', num_filters=96, filter_size=(3, 3), **conv_kwargs)
# 32
